...
const projects = [
  {
    id: 'startup',
    title: '스타트업 랜딩',
    description: '모던하고 세련된 스타트업 앱 랜딩 페이지',
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">랜딩 페이지 포트폴리오</h1>
          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            다양한 목적에 맞는 랜딩 페이지 디자인 포트폴리오입니다.
            제품 소개, 서비스 홍보, 앱 다운로드 유도 등 다양한 목적의 랜딩 페이지를 확인해보세요.
          </p>
        </div>
      </header>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              ...
              >
                <Link href={`/portfolio/landing/${project.id}`} className="block h-full">
