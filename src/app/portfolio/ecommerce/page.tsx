...
const projects = [
  {
    id: 'eco-shop',
    title: '에코샵',
    description: '환경 친화적인 제품을 판매하는 온라인 쇼핑몰로, 지속 가능한 소비를 장려합니다.',
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">이커머스 웹사이트 포트폴리오</h1>
          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            다양한 온라인 쇼핑몰 및 이커머스 플랫폼 디자인 포트폴리오입니다.
            사용자 경험과 전환율을 극대화하는 최적의 이커머스 솔루션을 확인해보세요.
          </p>
        </div>
      </header>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              ...
              >
                <Link href={`/portfolio/ecommerce/${project.id}`} className="block h-full">
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 max-w-3xl mx-auto">
            {['Next.js', 'React', 'Tailwind CSS', 'Stripe', 'Responsive Design'].map((tech) => (
              <div 
                key={tech}
