...
const projects = [
  {
    id: 'portfolio',
    title: '개인 포트폴리오',
    description: '미니멀한 디자인의 개인 포트폴리오 원페이지',
    image: 'https://images.unsplash.com/photo-1545239351-ef35f43d514b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80',
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">원페이지 포트폴리오</h1>
          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            한 페이지에 모든 정보를 담은 원페이지 디자인 포트폴리오입니다.
            개인 포트폴리오, 이력서, 소개 페이지 등 다양한 목적의 원페이지를 확인해보세요.
          </p>
        </div>
      </header>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              ...
              >
                <Link href={`/portfolio/onepage/${project.id}`} className="block h-full">
