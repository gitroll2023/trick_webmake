...
const projects = [
  {
    id: 'hwasun-drone',
    title: '화순 드론',
    description: '드론 서비스 기업 웹사이트',
    image: 'https://images.unsplash.com/photo-1527977966376-1c8408f9f108?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80',
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">기업 웹사이트 포트폴리오</h1>
          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            전문적이고 신뢰감 있는 기업 웹사이트 포트폴리오입니다.
            각 웹사이트는 기업의 아이덴티티와 비즈니스 목표를 반영하여 디자인되었습니다.
          </p>
        </div>
      </header>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              ...
              >
                <Link href={`/portfolio/corporate/${project.id}`} className="block h-full">
